# Train Multi-Class Mask R-CNN with Colab  
Use colab to train Mask R-CNN with custom dataset.  
jupyter notebook code for colab: maskrcnn_custom_tf_multi_class_colab.ipynb  
Upload "food.py" and "Food.zip" to colab file folder.  

Reference:  
https://github.com/CrookedNoob/Mask_RCNN-Multi-Class-Detection  
https://github.com/RomRoc/maskrcnn_train_tensorflow_colab  
